...
var SimpleTotal = big.Mul(big.NewInt(WdMining*3/10), big.NewInt(1e18))              // 330M for testnet, PARAM_FINISH
var BaselineTotal = big.Mul(big.NewInt(WdMining-(WdMining*3/10)), big.NewInt(1e18)) // 770M for testnet, PARAM_FINISH
